...
namespace Avalonia.Wayland
{
    internal class WlTextInputMethod : ITextInputMethodImpl, IDisposable, ZwpTextInputV3.IEvents
    {
        ...
        private static ZwpTextInputV3.ContentHintEnum ParseContentHints(TextInputOptionsQueryEventArgs options)
        {
        ...
        {            
            ...
            TextInputContentType.Phone => ZwpTextInputV3.ContentPurposeEnum.Phone,
